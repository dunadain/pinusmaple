...
export interface ILifeCycle {
    beforeStartup?(app: Application):Promise<void>;
    afterStartup?(app: Application):Promise<void>;
    ...
    beforeShutdown?(app: Application , cancelShutDownTimer: () => void):Promise<void>;
}